...
function getUserCellData(user: IUser) {
    return [
        {
            data: user.id,
        },
        ...
        {
            data: getUserFullAddress(user.address),
        },
    ]
}
  ...
  <div class="p-6 bg-white mx-auto rounded-lg shadow-md max-w-[1600px]">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
      ...
      <div class="flex gap-2 w-full md:w-auto">
        ...
        <!-- add button -->
        <button class="bg-gray-800 min-w-[150px] text-white text-sm font-bold px-4 py-2 rounded-md hover:bg-gray-700">
          Add new user
        </button>
      </div>
    </div>
